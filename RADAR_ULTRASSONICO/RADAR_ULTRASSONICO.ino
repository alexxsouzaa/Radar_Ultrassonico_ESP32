...
#define pinTrigger 18 // Pino de Trigger do sensor HC-SR04
#define pinEcho 19    // Pino de Echo do sensor HC-SR04
...
U8G2_SH1106_128X64_NONAME_F_HW_I2C u8g2(U8G2_R0, U8X8_PIN_NONE); // Driver do display OLED
